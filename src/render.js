...
// --- Automatically attach all named exports from modules to default export ---
// const modules = [utils, controls, barcharts, tables];
// modules.forEach(mod => {
//     Object.keys(mod).forEach(key => {
//         // Skip default export of each module if it exists
//         if (key !== 'default') {
//             BiasAnalyzerVis[key] = mod[key];
//         }
//     });
// });

// window.BiasAnalyzerVis = BiasAnalyzerVis;
// export default BiasAnalyzerVis;
//
